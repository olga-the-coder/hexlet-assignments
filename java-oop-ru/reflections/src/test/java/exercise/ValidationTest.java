...
class ValidationTest {
    ...
    void testValidateAdvanced() {
        ...
        Map<String, List<String>> expected3 = Map.of("country", List.of("length less than 4"), "city",
                List.of("can not be null"), "street", List.of("can not be null"), "houseNumber",
